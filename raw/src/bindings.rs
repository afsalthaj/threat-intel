...
pub mod rag {
    pub mod centroid_client {
        ...
        pub mod centroid_client {
            ...
            impl FutureProcessLocalModelResult {
                #[allow(unused_unsafe, clippy::all)]
                pub fn get(&self) -> Option<Result<NewModel, _rt::String>> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 16]);
                        let mut ret_area = RetArea(
    ...
    pub mod embeddings_client {
        ...
        pub mod embeddings_client {
            ...
            pub type GolemRpcUri = super::super::super::golem::rpc::types::Uri;
            pub type WasiIoPollable = super::super::super::wasi::io::poll::Pollable;
            pub type AddThreatResponse = super::super::super::rag::embeddings_exports::api::AddThreatResponse;
            pub type ThreatIntel = super::super::super::rag::embeddings_exports::api::ThreatIntel;
            #[derive(Debug)]
            #[repr(transparent)]
            pub struct FutureAddThreatResult {
                handle: _rt::Resource<FutureAddThreatResult>,
            }
            impl FutureAddThreatResult {
                #[doc(hidden)]
                pub unsafe fn from_handle(handle: u32) -> Self {
                    Self {
                        handle: _rt::Resource::from_handle(handle),
            ...
            unsafe impl _rt::WasmResource for FutureAddThreatResult {
                #[inline]
                unsafe fn drop(_handle: u32) {
                    #[cfg(not(target_arch = "wasm32"))]
                    unreachable!();
                    #[cfg(target_arch = "wasm32")]
                    {
                        ...
                        extern "C" {
                            #[link_name = "[resource-drop]future-add-threat-result"]
                            fn drop(_: u32);
                        }
                        drop(_handle);
                    }
            ...
            impl FutureAddThreatResult {
                ...
                pub fn subscribe(&self) -> WasiIoPollable {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]future-add-threat-result.subscribe"]
                            fn wit_import(_: i32) -> i32;
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32) -> i32 {
            ...
            impl FutureAddThreatResult {
                #[allow(unused_unsafe, clippy::all)]
                pub fn get(&self) -> Option<Result<AddThreatResponse, _rt::String>> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 16]);
                        let mut ret_area = RetArea(
                        ...
                        extern "C" {
                            #[link_name = "[method]future-add-threat-result.get"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32, _: *mut u8) {
                                    ...
                                    match l2 {
                                        0 => {
                                            let e = {
                                                ...
                                                super::super::super::rag::embeddings_exports::api::AddThreatResponse {
            ...
            impl Api {
                ...
                pub fn blocking_add_threat(
                    ...
                    unsafe {
                        ...
                        let super::super::super::rag::embeddings_exports::api::ThreatIntel {
                            id: id0,
                        ...
                        extern "C" {
                            #[link_name = "[method]api.blocking-add-threat"]
                            fn wit_import(
                                _: i32,
                                _: *mut u8,
                                _: usize,
                        ...
                        match l4 {
                            0 => {
                                let e = {
                                    ...
                                    super::super::super::rag::embeddings_exports::api::AddThreatResponse {
                                        description: _rt::string_lift(bytes7),
                                    }
                                };
                                Ok(e)
                            }
            ...
            impl Api {
                ...
                pub fn add_threat(
                    ...
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api.add-threat"]
                            fn wit_import(
                                _: i32,
                                _: *mut u8,
                                _: usize,
                        ...
                        FutureAddThreatResult::from_handle(ret as u32)
                    }
                }
            }
        }
        ...
        pub mod api {
            ...
            pub fn add_threat(
                ...
                unsafe {
                    ...
                    struct RetArea([::core::mem::MaybeUninit<u8>; 12]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 12]);
                    let ThreatIntel { id: id0, description: description0 } = threat_intel;
                    let vec1 = id0;
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();
                    let vec2 = description0;
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa7\x20\x01A\x02\x01\
A\x1b\x01B\x0a\x04\0\x08pollable\x03\x01\x01h\0\x01@\x01\x04self\x01\0\x7f\x04\0\
...
olem:rpc/types@0.1.1\x05\x02\x01B\x07\x01r\x01\x05values\x04\0\x0blocal-model\x03\
\0\0\x01r\x01\x05values\x04\0\x09new-model\x03\0\x02\x01j\x01\x03\x01s\x01@\x01\x03\
log\x01\0\x04\x04\0\x13process-local-model\x01\x05\x03\0\x18rag:centroid-exports\
/api\x05\x03\x02\x03\0\x01\x03uri\x02\x03\0\x02\x0blocal-model\x02\x03\0\x02\x09\
new-model\x01B\x1b\x02\x03\x02\x01\x04\x04\0\x0dgolem-rpc-uri\x03\0\0\x02\x03\x02\
\x01\x01\x04\0\x10wasi-io-pollable\x03\0\x02\x02\x03\x02\x01\x05\x04\0\x0blocal-\
model\x03\0\x04\x02\x03\x02\x01\x06\x04\0\x09new-model\x03\0\x06\x04\0!future-pr\
ocess-local-model-result\x03\x01\x04\0\x03api\x03\x01\x01h\x08\x01i\x03\x01@\x01\
\x04self\x0a\0\x0b\x04\03[method]future-process-local-model-result.subscribe\x01\
\x0c\x01j\x01\x07\x01s\x01k\x0d\x01@\x01\x04self\x0a\0\x0e\x04\0-[method]future-\
process-local-model-result.get\x01\x0f\x01i\x09\x01@\x01\x08location\x01\0\x10\x04\
\0\x10[constructor]api\x01\x11\x01h\x09\x01@\x02\x04self\x12\x03log\x05\0\x0d\x04\
\0([method]api.blocking-process-local-model\x01\x13\x01i\x08\x01@\x02\x04self\x12\
\x03log\x05\0\x14\x04\0\x1f[method]api.process-local-model\x01\x15\x03\0#rag:cen\
troid-client/centroid-client\x05\x07\x01B\x07\x01r\x01\x0bdescriptions\x04\0\x13\
add-threat-response\x03\0\0\x01r\x02\x02ids\x0bdescriptions\x04\0\x0cthreat-inte\
l\x03\0\x02\x01j\x01\x01\x01s\x01@\x01\x0cthreat-intel\x03\0\x04\x04\0\x0aadd-th\
reat\x01\x05\x03\0\x1arag:embeddings-exports/api\x05\x08\x02\x03\0\x04\x13add-th\
reat-response\x02\x03\0\x04\x0cthreat-intel\x01B\x1b\x02\x03\x02\x01\x04\x04\0\x0d\
golem-rpc-uri\x03\0\0\x02\x03\x02\x01\x01\x04\0\x10wasi-io-pollable\x03\0\x02\x02\
\x03\x02\x01\x09\x04\0\x13add-threat-response\x03\0\x04\x02\x03\x02\x01\x0a\x04\0\
\x0cthreat-intel\x03\0\x06\x04\0\x18future-add-threat-result\x03\x01\x04\0\x03ap\
i\x03\x01\x01h\x08\x01i\x03\x01@\x01\x04self\x0a\0\x0b\x04\0*[method]future-add-\
threat-result.subscribe\x01\x0c\x01j\x01\x05\x01s\x01k\x0d\x01@\x01\x04self\x0a\0\
\x0e\x04\0$[method]future-add-threat-result.get\x01\x0f\x01i\x09\x01@\x01\x08loc\
ation\x01\0\x10\x04\0\x10[constructor]api\x01\x11\x01h\x09\x01@\x02\x04self\x12\x0c\
threat-intel\x07\0\x0d\x04\0\x1f[method]api.blocking-add-threat\x01\x13\x01i\x08\
\x01@\x02\x04self\x12\x0cthreat-intel\x07\0\x14\x04\0\x16[method]api.add-threat\x01\
\x15\x03\0'rag:embeddings-client/embeddings-client\x05\x0b\x01B\x09\x01r\x01\x05\
values\x04\0\x07context\x03\0\0\x01r\x01\x05values\x04\0\x0cllm-response\x03\0\x02\
\x01r\x01\x0bdescriptions\x04\0\x06prompt\x03\0\x04\x01j\x01\x03\x01s\x01@\x02\x06\
prompt\x05\x07context\x01\0\x06\x04\0\x09ask-model\x01\x07\x03\0\x13rag:llm-expo\
rts/api\x05\x0c\x02\x03\0\x06\x07context\x02\x03\0\x06\x0cllm-response\x02\x03\0\
\x06\x06prompt\x01B\x1d\x02\x03\x02\x01\x04\x04\0\x0dgolem-rpc-uri\x03\0\0\x02\x03\
\x02\x01\x01\x04\0\x10wasi-io-pollable\x03\0\x02\x02\x03\x02\x01\x0d\x04\0\x07co\
ntext\x03\0\x04\x02\x03\x02\x01\x0e\x04\0\x0cllm-response\x03\0\x06\x02\x03\x02\x01\
\x0f\x04\0\x06prompt\x03\0\x08\x04\0\x17future-ask-model-result\x03\x01\x04\0\x03\
api\x03\x01\x01h\x0a\x01i\x03\x01@\x01\x04self\x0c\0\x0d\x04\0)[method]future-as\
k-model-result.subscribe\x01\x0e\x01j\x01\x07\x01s\x01k\x0f\x01@\x01\x04self\x0c\
\0\x10\x04\0#[method]future-ask-model-result.get\x01\x11\x01i\x0b\x01@\x01\x08lo\
cation\x01\0\x12\x04\0\x10[constructor]api\x01\x13\x01h\x0b\x01@\x03\x04self\x14\
\x06prompt\x09\x07context\x05\0\x0f\x04\0\x1e[method]api.blocking-ask-model\x01\x15\
\x01i\x0a\x01@\x03\x04self\x14\x06prompt\x09\x07context\x05\0\x16\x04\0\x15[meth\
od]api.ask-model\x01\x17\x03\0\x19rag:llm-client/llm-client\x05\x10\x01B\x16\x01\
r\x02\x04paths\x04hashs\x04\0\x09file-info\x03\0\0\x01r\x02\x02ips\x08hostnames\x04\
\0\x09host-info\x03\0\x02\x01r\x01\x07messages\x04\0\x09log-event\x03\0\x04\x01r\
\x05\x09source-ips\x0edestination-ips\x04port{\x08protocols\x06actions\x04\0\x0c\
network-info\x03\0\x06\x01r\x03\x04names\x03pidy\x04paths\x04\0\x0cprocess-info\x03\
\0\x08\x01r\x01\x06details\x04\0\x08response\x03\0\x0a\x01r\x02\x08usernames\x04\
roles\x04\0\x09user-info\x03\0\x0c\x01k\x07\x01k\x09\x01k\x01\x01r\x0a\x09timest\
amps\x06sources\x0aevent-types\x08severitys\x04host\x03\x04user\x0d\x07network\x0e\
\x07process\x0f\x04file\x10\x07messages\x04\0\x0esecurity-event\x03\0\x11\x01j\x01\
\x0b\x01s\x01@\x01\x03log\x05\0\x13\x04\0\x11process-log-event\x01\x14\x04\0\x13\
rag:raw-exports/api\x05\x11\x04\0\x0brag:raw/raw\x04\0\x0b\x09\x01\0\x03raw\x03\0\
